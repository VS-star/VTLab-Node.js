...
router.route('/filter').get(
  (req, res, next) =>
    handler(getValidator, req, res, next, validations['filterGet']),
...
router.route('/edit').post(
  (req, res, next) =>
    handler(validator, req, res, next, validations['editPost']),
  (req, res, next) => responses(deliveriesCommonServices.edit, req, res, next)
);
